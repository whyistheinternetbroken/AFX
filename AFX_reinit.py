...
def _peer_reinit_worker(ip, ctx):
    ...
    per-run state that each thread needs:
      ...
      admin_password, log, peer_errors, peer_lock, menu_sigs_lower, status,
      cluster_ips_out.
    """
